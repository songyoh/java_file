...
public class CastingExample2 {
	public static void main(String[] args) {
		/*
		 * 크기가 큰 데이터를 작은 데이터타입으로 바꾸려명
		 * 반드시 캐스팅 연산자(type)을 사용하여
		 * 명시적으로 형 변환을 해야 합니다(downcasting)
		 */
		int i = 72;//4바이트 int
		char c = (char)i;// int -> char는 자동 변환이 되지 않으므로 char로 바꾼다 명시해야함.(2바이트)
		System.out.println(c);
		
		/*
		 * 강제 형변환의 경우 데이터 손실이 일어날 가능서이
		...
		int k = 1024;
		byte b = (byte)k;// -128 ~ +127 범위에 1024 집어넣기 (byte=1바이트)
