...
public class SwitchExample1 {
	...
	public static void main(String[] args) {
		...
		switch(order) { // order는 변수에 무슨값이 매칭되는지, 순번은 상관없음.
		case 1: // order의 숫자가 1과 일치하면 "주문하신 카페라떼 나왔습니다." 실행
			System.out.println("주문하신 카페라떼 나왔습니다.");		
			break;// break라는 구문을 case의 마지막에 작성해야 코드가 흘러내리지 않습니다.
		case 2: // order의 숫자가 2와 일치하면 "주문하신 아메리카노 나왔습니다." 실행
			System.out.println("주문하신 아메리카노 나왔습니다.");
			break;
		case 3: // order의 숫자가 3과 일치하면 "주문하신 녹차프라푸치노 나왔습니다." 실행
			System.out.println("주문하신 녹차프라푸치노 나왔습니다.");
			break;// 마지막 case에는 break를 잘 안 달지만, 가독성 문제로 달기도 함.
		default:
