...
public class ArrayExample {
	...
	public static void main(String[] args) {
		...
		int[] score; // int score[]; 도 가능 , 한줄생성 가능
		
		// 배열의 생성 - heap에 실제 데이터가 저장될 공간을 생성
		// 배열은 생성시 크기를 명시함. 한 번 크기 세팅시 조정 불가
		score = new int[5]; // int 5개를 담을 수 있는 크기로 score 생성(주소262b2c86를 담는다)
		 ...
		 */
		System.out.println(Arrays.toString(score));//이 주소에 방문해보라는 뜻
		
		// 배열의 길이를 알아보려면 변수명.length를 사용합니다.
		System.out.println(score.length); //score(번지)에 나와있는 길이를 물어본 것
