...
public class MethodExample3 {
	 ...
	 * 	  매직넘버 대신 사용할 수 있습니다.
	 * 
	 * 6. 반환값이 없는 메서드는 void를 기입합니다. 이 때는 return구문을 쓰지 않아도 됩니다.
	 * 
	...
	public static void callMyName(String name) {
		...
		if(name.length() < 2) {
			...
			return;    //break와 비슷
			//System.out.println("에러뜸"); //Unreachable code
		}
	...
	public static int[] totalOperate(int n1, int n2) {
		int[] total = {n1+n2, n1-n2, n1*n2, n1/n2}; //참조형 변수
		return total;
	}
	...
	public static void main(String[] args) {
		...
		//System.out.println(add(3, 5))와 결과가 동일하다
		...
		// 만약 int[] tot = totalOperate(20);경우 MethodExample3 유형의 totalOperate(int, int) 
		// 메서드는 인수(int)에 적용할 수 없습니다.로 에러가 뜸
		...
		callMyName("오");// 반환값이 void이며 return구문이 실행됨	
	}
