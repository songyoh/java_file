...
public class ArraysSearch {
	...
	public static void main(String[] args) {
		...
		int[] scores2 = Arrays.copyOf(scores, scores.length);//Arrays.copyOf(scores, 3)
		...
		// Arrays.equals(배열1, 배열2) : 배열 내부 요소 비교 // 값비교
		int[] arr1 = {1,3,5,7,9};
		int[] arr2 = {1,3,5,7,9};
		String result = Arrays.equals(arr1, arr2) ? "항목일치" : "항목불일치"; 
					//Arrays.equals없이 (arr1==arr2) 할 경우에는 힙에 배정된 주소가 다르므로 항목 불일치로 나오게된다
